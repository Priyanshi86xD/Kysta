...
module.exports = async (client) => {
      ...
      member
        .sendCustom({
          embeds: [
            new MessageEmbed()
              .setColor("GREEN")
              .setFooter({ text: `Powered by https://kysta.tech` })
  ...
  app.get("/dashboard/:guildID", checkAuth, async (req, res) => {
    ...
    renderTemplate(res, req, "./new/mainpage.ejs", {
      guild: guild,
      alert: `The Dashboard is in beta mode!`,
...
In the mean time, please explain your issue below`;
    ...
    if (Object.prototype.hasOwnProperty.call(data, "sendEmbed")) {
      ...
      if (ticketSettings.ticketToggle == "true") {
        if (
          ...
          if (storedSettings.isPremium == "false") {
            ticketSettings.ticketFooter = "Powered by kysta.tech";
          } else {
          ...
          let reactionFooter = "Powered by kysta.tech";

          let footer = "Powered by kysta.tech";
          // eslint-disable-next-line no-unused-vars
          ...
          if (storedSettings.isPremium == "false") {
            ticketEmbed.setFooter({ text: `Powered by kysta.tech` });
          } else {
            if (checkFooter) {
  ...
  app.post("/dblwebhook", webhook.middleware(), async (req) => {
    ...
    const msg = new Discord.MessageEmbed()
      ...
      .setDescription(
        `Thank you **${apiUser.username}#${apiUser.discriminator}** (${apiUser.id}) for voting **Kysta**!`
      );
    Hook.sendCustom(msg);
