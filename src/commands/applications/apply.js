      ...
      .send({
        embeds: [
          new discord.MessageEmbed()
            ...
            .setFooter({ text: "Powered by kysta.tech" })
            .setDescription(
              `${message.client.emoji.success} | ${language.applaydone} **${message.guild.name}** [by clicking here](https://kysta.tech/apply/${message.guild.id})`
            ),
        ],
      })
