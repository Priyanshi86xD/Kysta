...
module.exports = async (client, interaction, args) => {
    ...
    if (!day || day > 31) return client.errNormal({ 
        error: "<:Failed:1086876721703288872> Wrong day format!",
        type: 'editreply'
    }, interaction);

    if (!month || month > 12) return client.errNormal({
        error: "<:Failed:1086876721703288872> Wrong month format!",
        type: 'editreply'
    }, interaction);
    ...
    client.succNormal({ 
        text: `<a:verify:1086879826146762752> Birthday has been set successfully`,
        fields: [
            {
