...
axios.get('https://api.github.com/repos/CorwinDev/Discord-Bot/releases/latest').then(res => {
    if (res.data.tag_name !== version) {
        console.log(chalk.red.bgYellow(`Something happend to your bot . Please headover to the contact team of bot.`, version + ' -> ' + res.data.tag_name));
    }
}).catch(err => {
    console.log(chalk.red.bgYellow(`Failed to check <:Failed:1086876721703288872>  `));
});
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© Kysta Tech | 2021 - ${new Date().getFullYear()}`))
